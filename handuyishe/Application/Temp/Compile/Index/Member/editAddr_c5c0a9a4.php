...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
    ...
    <table class="hd-form hd-table hd-table-form">
        ...
        <tr>
            ...
            <td>
                <input name="receiver" type="text" value="<?php echo $info['receiver'];?>">
            </td>
        </tr>
        <tr>
            <th>所在地区</th>
        ...
        <tr>
            <th>详细地址</th>
            <td>
                <input name="address" type="text" value="<?php echo $info['address'];?>">
            </td>
        </tr>
        <tr>
            <th>电话</th>
            <td>
                <label><input name="phone" type="text" value="<?php echo $info['phone'];?>"> 
                <span id="hd_sex"></span>
            </td>
        </tr>
        <tr>
            <th>email</th>
            <td>
                <label><input name="email" type="text" value="<?php echo $info['email'];?>"> 
                <span id="hd_sex"></span>
            </td>
        </tr>
        </tbody>
    </table>
    <input name="addr_id" type="hidden" value="<?php echo $hd['get']['addr_id'];?>"> 
