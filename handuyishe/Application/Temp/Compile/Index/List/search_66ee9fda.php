...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="http://127.0.0.1/Joker-tK/handu/handu/Static/index/css/search.css"/>
		...
		<script type="text/javascript" src="http://127.0.0.1/Joker-tK/handu/handu/Static/index/js/list.js"></script>
    ...
    <ul class="handu_menu_o ">
		...
		<div id="listContent">
			<div class="listContent">
				...
				<div class="cateRight" style="padding: 0px;width: 1200;">
					<h3 style="padding-top: 15px;;font-size: 20px;">搜索结果:</h3>
					<div class="productGrid">
						<div class="productGridin" style="border: 1px solid #CCCCCC; padding-top: 50px;">
							<ul>
								    <?php if(!empty($goods)){ ?>
								<?php foreach ($goods as $k=>$v){?>
								<li class="">
									<div class="">
										<a href="<?php echo U('details/index',array('gid'=>$v['gid']));?>"><img src="http://127.0.0.1/Joker-tK/handu/handu/<?php echo $v['indexpic'];?>"/></a>
							...
							<h3 style="text-align: center;clear: both;"><?php echo $page;?></h3>
						</div>
					</div>
				</div>
			</div>
...
<!--尾部开始-->
		...
		<script type="text/javascript">
			$(function(){
				$('cateTree dt').toggle(function(){
					$(this).find('.h3TopCate').show();
				},function(){
					$(this).find('.h3TopCate').hide();
				});
			})
		</script>
	</body>
