...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="http://127.0.0.1/Joker-tK/handu/handu/Static/index/css/login.css"/>
...
<!--顶部导航开始-->
  ...
  <div class="handu_menu ">
    ...
    <ul class="handu_menu_o ">
		...
		<div class="loginAll">
			<div class="loginAd">
				<img src="http://127.0.0.1/Joker-tK/handu/handu/Static/index/images/banner1.jpg" alt="" />
			</div>
			<div class="loginContent">
				<div class="loginLeft">
					<img src="http://127.0.0.1/Joker-tK/handu/handu/Static/index/images/410-290.png"/>
				</div>
					...
					<div class="loginForm">
						...
						<div class="inputSome">
							<form action="<?php echo U('Login/login');?>" method="post">
								<p>	<span>邮箱：</span><input type="text" name="email" placeholder="请填邮箱"/></p>
								<p>	<span>密码：</span><input type="password" name="password" /></p>
								<p class="submitP">	<span></span><input type="submit"  class="submit" value="立即登录"/>
									<!--<input type="checkbox" value="1" name="" class="checkbox"/><span class="save">
	保存登录信息 </span>--></p>
							</form>
								<p class="toRegister"><a href="<?php echo U('Register/register');?>" class="register" >注册</a>| <a href="">忘记密码？</a></p>
