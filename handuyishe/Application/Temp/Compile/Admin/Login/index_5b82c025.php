...
<head>
	...
	<link rel="stylesheet" href="http://localhost/handuyishe/Static/Admin/Css/login.css" />
	<script type="text/javascript" src="http://localhost/handuyishe/Static/Admin/Js/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="http://localhost/handuyishe/Static/Admin/Js/login.js"></script>
...
<body>
	<div id="divBox">
		<form action="" method="POST" id="login">
			...
			<img src="<?php echo U('Login/verify');?>" id="verify_img" style="margin-top: 4px;"/>
		</form>
		<div class="four_bj">
