...
<head>
    ...
    <title>hdcms</title>
    <link rel="stylesheet" type="text/css" href="http://localhost/handuyishe/Static/admin/hdjs/hdjs.css"/>
    <link rel="stylesheet" type="text/css" href="http://localhost/handuyishe/Application/Admin/View/Index/Css/welcome.css">
</head>
<body>
<div class="wrap">
    ...
    <table class="hd-table hd-table-list">
        ...
        <tr>
            <td>运行环境</td>
            <td>
                <?php echo $hd['SERVER']['SERVER_SOFTWARE'];?>
            </td>
        </tr>
        <tr>
            <td>允许上传大小</td>
